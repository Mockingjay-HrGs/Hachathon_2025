 ...
 */
class getProduitsInfoRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProduitsInfoRepository' shared autowired service.
     *
     * @return \App\Repository\ProduitsInfoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProduitsInfoRepository.php';

        return $container->privates['App\\Repository\\ProduitsInfoRepository'] = new \App\Repository\ProduitsInfoRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
